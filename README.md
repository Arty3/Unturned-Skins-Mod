...
| [SkinsMod.zip](https://github.com/Arty3/Unturned-Skins-Mod/releases/download/v1.3/SkinsMod.zip) | 1.3 | Missing Assets | Added Limestone Assets |
| [SkinsMod.zip](https://github.com/Arty3/Unturned-Skins-Mod/releases/download/v1.4/SkinsMod.zip) | 1.4 | Yes | Added California 2 Assets |
...
- Mod will generate particle craft over mythical variant (e.g. Energized Hypertech Maplestrike will be particle effect instead of Mythical). Doesn't affect actual skin appearance
