    ...
    public class EconInfoLoader
    {
        ...
        */
        ...
        private static Dictionary<ushort, EffectColorPair> _allEffects = new Dictionary<ushort, EffectColorPair>()
        {
			...
			{ 70, new EffectColorPair("Radar Locked",       new Color { r = 0,   g = 255, b = 255, a = 1f }) },
			{ 71, new EffectColorPair("Heat Locked",        new Color { r = 255, g = 0,   b = 0,   a = 1f }) },
			...
			{ 69, new EffectColorPair("Loaded",             new Color { r = 255, g = 0,   b = 0,   a = 1f }) },
			{ 68, new EffectColorPair("Lit",                new Color { r = 255, g = 130, b = 0,   a = 1f }) },
			...
			{ 72, new EffectColorPair("Fractured",          new Color { r = 255, g = 255, b = 255, a = 1f }) },
